...
**** View-user
- =view-user.html=
#+BEGIN_SRC javascript :tangle ../../src/static/partials/view-user.html :eval no
<div class="row">
  <div class="col-md-4"></div>
  <div class="col-md-5"><h2>Details of <b>{{ name }}</b></h2></div>
  <div class="col-md-3">
...
#+END_SRC
**** Add-user
#+BEGIN_SRC javascript :tangle ../../src/static/partials/add-user.html :eval no
<div class="row">
  <div class="col-md-4"></div>
  <div class="col-md-4">
    <h2>Add User</h2>
...
#+END_SRC
**** Edit-user
#+BEGIN_SRC javascript :tangle ../../src/static/partials/edit-user.html :eval no
